# -*- coding: utf-8 -*-
"""qwen-med-lora-50-chat-model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Gm8NMVkL1IUhI_3GQ0Hw0IJksUsQ8pjH
"""
...
import os
os.environ["HF_HUB_DISABLE_PROGRESS_BARS"] = "1"   # stop tqdm in HF Hub
os.environ["TQDM_DISABLE"] = "1"                    # belt & suspenders
os.environ["TOKENIZERS_PARALLELISM"] = "false"      # calmer in Spyder



ADAPTER_DIR = "/Users/andreacardiel/Downloads/qwen-med-lora-50"
...
# super-simple chat session wrapper ---
class Chat:
    def __init__(self, model, tokenizer, system="You are a careful, empathetic clinical assistant."):
        self.model = model
        self.tok = tokenizer
        self.messages = [{"role": "system", "content": system}]
        # small stability/speed tweaks
        torch.backends.cuda.matmul.allow_tf32 = True
        self.model.config.use_cache = True  # ok for inference
